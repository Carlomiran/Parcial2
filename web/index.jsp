<%-- 
    Document   : index
    Created on : 19/09/2020, 10:53:32 AM
    Author     : carlo
--%>
      ...
      <div class="collapse navbar-collapse justify-content-md-center">
        <ul class="navbar-nav">
          <li class="nav-item active">
            <a class="nav-link" href="index.jsp">BIENVENIDO A TIENDA FOCUS<span class="sr-only">(current)</span></a>
          </li>
        </ul>
      </div>
    </nav>
        ...
        <div class="modal-body">
            ...
            <div class="form-group col-auto">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="txt_producto" id="txt_producto" class="form-control" placeholder="HaloAniversary" required>    
                </div>
                <br>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="txt_descripcion" id="txt_descripcion" class="form-control" placeholder="Ejemplo: Accion y Aventura" required> 
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="txt_pcosto" id="txt_pcosto" class="form-control" placeholder="Ejemplo: 250.00" required> 
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="txt_pventa" id="txt_pventa" class="form-control" placeholder="Ejemplo: 500.00" required> 
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="txt_existencia" id="txt_existencia" class="form-control" placeholder="Ejemplo: 10" required>
                </div>
